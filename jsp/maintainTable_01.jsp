...
<script>
	...
	var params ={userId:userId,tableName:targetTable};
</script>
...
<body>
	...
	<div ng-controller="GridController">
		<div class="container-fluid" ng-controller="GridToolBarCtrl">
			<ul class="nav navbar-nav">
				<li><button class="btn btn-primary navbar-btn" table-status disabled></button></li>
			</ul>
			<ul class="nav navbar-nav navbar-right">
        ...
        <div id="dataGrid" ui-grid="gridOptions" class="grid" ui-grid-edit ui-grid-selection></div>
    ...
    <script src="../app/maintainTable_01.js"></script>
